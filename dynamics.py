...
from rotation import euler_to_quaternion, quaternion_to_euler
...
def dynamics(state: torch.Tensor, action: torch.Tensor):
...
def orbital_elements_from_cartesian_torch(r_vec, v_vec, mu=398600.4418):
...
elements = orbital_elements_from_cartesian_torch(r_vec, v_vec)
print(elements)
